...
export default function Playing({ gameResult, chosenNumber, solutionNumber, randomNumbers, chooseNumber, gameStatus}) {
    ...
    return <>
        ...
        <Cards chosenNumber={chosenNumber} solutionNumber={solutionNumber} randomNumbers={randomNumbers} chooseNumber={chooseNumber} gameResult={gameResult} gameStatus={gameStatus} />
    </>
}